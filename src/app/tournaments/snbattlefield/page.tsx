 ...
 */
import { snBattleFieldTournament, isTournamentStreamed } from "@/data";
      ...
      <div className="min-h-screen bg-slate-950">
        ...
        <div className="pt-24 md:pt-28 lg:pt-32">
          <div className="container mx-auto px-4 pb-8 space-y-16">
            ...
            <section>
              <TournamentHeader
                tournament={snBattleFieldTournament}
            ...
            {/* Tournament Details */}
            <section>
              <TournamentDetails tournament={snBattleFieldTournament} />
            </section>

            {/* Live Tournament Slots from Google Sheets */}
            <section>
              <TournamentSlotsLive
                maxTeams={snBattleFieldTournament.maxTeams}
            ...
            {/* Call to Action */}
            {isTournamentStreamed(snBattleFieldTournament) && (
              <section>
                <CallToAction
                  isStreamed={isTournamentStreamed(snBattleFieldTournament)}
                  registrationUrl={snBattleFieldTournament.registrationUrl}
                  youtubeVideoId={snBattleFieldTournament.youtubeVideoId}
                  tournamentName={snBattleFieldTournament.name}
                />
              </section>
            )}
          </div>
